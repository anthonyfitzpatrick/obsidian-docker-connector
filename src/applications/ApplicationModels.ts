import type { DockerContainerHealth, DockerContainerState } from "../containers/ContainerModels";
...
export interface DockerApplicationContainerSummary {
  id: string; displayName: string; serviceName: string; state: DockerContainerState; health: DockerContainerHealth; image: string; oneOff: boolean; updateAvailable: boolean;
}
