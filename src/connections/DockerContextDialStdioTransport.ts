...
export class DockerContextDialStdioTransport implements DockerTransport {
  private child?: ChildProcessWithoutNullStreams; private buffer = ""; private stderr = ""; private connected = false; private requestQueue = Promise.resolve(); private pending?: { resolve: (body: string) => void; reject: (error: Error) => void; timer: ReturnType<typeof setTimeout> }; private localTransport?: LocalDockerTransport; private executionRoute?: DockerContextExecutionRoute;
