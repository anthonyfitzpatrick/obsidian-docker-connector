...
type DesktopTransportModule = { createDesktopTransport(profile: DockerConnectionProfile, credentials: RuntimeCredentialStore): DockerTransport };
...
class UnsupportedDesktopTransport implements DockerTransport {
  ...
  async connect(): Promise<void> { throw new DockerConnectionError("DESKTOP_CONNECTION_METHOD", "This connection method is available on desktop Obsidian only."); }
