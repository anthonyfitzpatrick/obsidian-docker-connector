...
| [ ] | 15 | `15-private-key-test-success.png` | Private-key diagnostics, **Test Connection** / **Save Host**. Username already redacted | Footer **Test connection** / **Save host**. Keep the username redacted |
